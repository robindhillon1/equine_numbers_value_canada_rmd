...
The R programming language and the following R packages were used to perform the analysis: knitr [@knit] and tidyverse [@tidy]. The code used to perform the analysis and create this report can be found here: <https://github.com/ttimbers/equine_numbers_value_canada_rmd>.
...
To run in console: `rmarkdown::render("doc/hist_horse_pop.Rmd")`

To run in terminal: `Rscript -e "rmarkdown::render('doc/hist_horse_pop.Rmd')"`

-   `Rscript -e "rmarkdown::render('doc/hist_horse_pop.Rmd', output_format = 'pdf_document', params=list(province='Alberta'))"`

-   Jupyter: `jupyter nbconvert --execute --to html hello.ipynb` - the above runs the cells and creates output
